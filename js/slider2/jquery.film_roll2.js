...
/*
  ...
  Usage:
    var film_roll = new FilmRoll2({container: '#container_id', OPTIONS});
 */
var bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };

(function($) {
  this.FilmRoll2 = (function() {
    function FilmRoll2(options) {
      var inst;
      ...
      if (this.options.container) {
        ...
        if (this.div.length) {
          inst = this.div.data('slider2__instance');
          if (inst) {
            return inst;
          }
          inst = this.configure();
          this.div.data('slider2__instance', inst);
          return inst;
        }
      }
    }

    FilmRoll2.prototype.configure = function() {
      var first_child;
      this.children = this.div.children();
      this.children.wrapAll('<div class="slider2__wrapper"></div>');
      this.children.wrapAll('<div class="slider2__shuttle"></div>');
      this.wrapper = this.div.find('.slider2__wrapper');
      this.shuttle = this.div.find('.slider2__shuttle');
      this.rotation = [];
      ...
      if (!(this.options.no_css === true || document.film_roll_styles_added)) {
        $("<style type='text/css'> .slider2__wrapper{display:block;text-align:center;float:none;position:relative;top:auto;right:auto;bottom:auto;left:auto;z-index:auto;width:100%;height:100%;margin:0 !important;padding:0 !important;overflow:hidden;} .slider2__shuttle{text-align:left;float:none;position:relative;top:0;left:0;right:auto;bottom:auto;height:100%;margin:0 !important;padding:0 !important;z-index:auto;} .slider2__shuttle.vertical_center:before{content:'';display:inline-block;height:100%;vertical-align:middle;margin-right:-0.25em;} .slider2__child{position:relative;display:inline-block;*display:inline;vertical-align:middle;zoom:1;} .slider2__prev,.slider2__next{position:absolute;top:48%;left:15px;width:40px;height:40px;margin:-20px 0 0 0;padding:0;font-size:60px;font-weight:100;line-height:30px;color:white;text-align:center;background:#222;border:3px solid white;border-radius:23px;opacity:0.5} .slider2__prev:hover,.slider2__next:hover{color:white;text-decoration:none;opacity:0.9} .slider2__next{left:auto;right:15px} .slider2__pager{text-align:center;} .slider2__pager a{width:5px;height:5px;border:2px solid #333;border-radius:5px;display:inline-block;margin:0 5px 0 0;transition:all 1s ease} .slider2__pager a:hover{background:#666} .slider2__pager a.active{background:#333} .slider2__pager span{display:none} .slider2__pager a,a.slider2__prev,a.slider2__next{-webkit-box-sizing: content-box;-moz-box-sizing: content-box;box-sizing: content-box;} </style>").appendTo('head');
        document.film_roll_styles_added = true;
      }
      if (this.options.pager !== false) {
        this.pager = $('<div class="slider2__pager">');
      ...
      this.pager_links = this.div.find('.slider2__pager a');
      ...
      if (this.options.hover !== false) {
        this.mouse_catcher = $('<div style="position:absolute; top:0; left: 0; height: 100%; width: 100%;" class="slider2__mouse_catcher"></div>');
      ...
      if (this.options.prev !== false) {
        if (this.options.prev && this.options.next) {
          ...
          this.wrapper.append('<a class="slider2__prev" href="#">&lsaquo;</a>');
          this.prev = this.div.find('.slider2__prev');
        }
      ...
      if (this.options.next !== false) {
        if (this.options.next) {
          ...
          this.wrapper.append('<a class="slider2__next" href="#">&rsaquo;</a>');
          this.next = this.div.find('.slider2__next');
        }
      ...
      this.easing = this.options.easing || FilmRoll2.default_easing;
    ...
    FilmRoll2.prototype.bestDirection = function(child, rotation_index) {
    ...
    FilmRoll2.prototype.cancelClick = function(event) {
    ...
    FilmRoll2.prototype.childIndex = function(child) {
      return $.inArray(child, this.children);
    };

    FilmRoll2.prototype.childWidth = function(child) {
      var index;
      index = this.childIndex(child);
      return this.child_widths[index] || $(child).outerWidth(true);
    };

    FilmRoll2.prototype.clearScroll = function() {
    ...
    FilmRoll2.prototype.configureHover = function() {
    ...
    FilmRoll2.prototype.configureLoad = function() {
    ...
    FilmRoll2.prototype.configureScroll = function() {
    ...
    FilmRoll2.prototype.configureSwipe = function() {
    ...
    FilmRoll2.prototype.configureWidths = function() {
      var min_height;
      ...
      this.shuttle.width('').removeClass('slider2__shuttle').addClass('slider2__resizing');
      this.children.width('');
      ...
      this.shuttle.width(this.real_width * 2).removeClass('slider2__resizing').addClass('slider2__shuttle');
    ...
    FilmRoll2.prototype.rotationIndex = function(child) {
      return $.inArray(child, this.rotation);
    };

    FilmRoll2.prototype.marginLeft = function(rotation_index) {
    ...
    FilmRoll2.prototype.marginRight = function(rotation_index) {
    ...
    FilmRoll2.prototype.moveLeft = function() {
      this.index = (this.index + 1) % this.children.length;
      this.moveToIndex(this.index, 'left', true);
      return false;
    };

    FilmRoll2.prototype.moveRight = function() {
      this.index -= 1;
      if (this.index < 0) {
    ...
    FilmRoll2.prototype.moveToChild = function(element) {
      var child_index;
    ...
    FilmRoll2.prototype.moveToIndex = function(index, direction, animate) {
    ...
    FilmRoll2.prototype.resize = function() {
    ...
    FilmRoll2.prototype.rotateLeft = function() {
    ...
    FilmRoll2.prototype.rotateRight = function() {
  ...
  return this.FilmRoll2.default_easing = 'swing';
})(jQuery);
