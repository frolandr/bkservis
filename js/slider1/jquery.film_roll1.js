...
/*
  ...
  Usage:
    var film_roll = new FilmRoll1({container: '#container_id', OPTIONS});
 */
var bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };

(function($) {
  this.FilmRoll1 = (function() {
    function FilmRoll1(options) {
      var inst;
      ...
      if (this.options.container) {
        ...
        if (this.div.length) {
          inst = this.div.data('slider1__instance');
          if (inst) {
            return inst;
          }
          inst = this.configure();
          this.div.data('slider1__instance', inst);
          return inst;
        }
      }
    }

    FilmRoll1.prototype.configure = function() {
      var first_child;
      this.children = this.div.children();
      this.children.wrapAll('<div class="slider1__wrapper"></div>');
      this.children.wrapAll('<div class="slider1__shuttle"></div>');
      this.wrapper = this.div.find('.slider1__wrapper');
      this.shuttle = this.div.find('.slider1__shuttle');
      this.rotation = [];
      ...
      if (!(this.options.no_css === true || document.film_roll_styles_added)) {
        $("<style type='text/css'> .slider1__wrapper{display:block;text-align:center;float:none;position:relative;top:auto;right:auto;bottom:auto;left:auto;z-index:auto;width:100%;height:100%;margin:0 !important;padding:0 !important;overflow:hidden;} .slider1__shuttle{text-align:left;float:none;position:relative;top:0;left:0;right:auto;bottom:auto;height:100%;margin:0 !important;padding:0 !important;z-index:auto;} .slider1__shuttle.vertical_center:before{content:'';display:inline-block;height:100%;vertical-align:middle;margin-right:-0.25em;} .slider1__child{position:relative;display:inline-block;*display:inline;vertical-align:middle;zoom:1;} .slider1__prev,.slider1__next{position:absolute;top:48%;left:15px;width:40px;height:40px;margin:-20px 0 0 0;padding:0;font-size:60px;font-weight:100;line-height:30px;color:white;text-align:center;background:#222;border:3px solid white;border-radius:23px;opacity:0.5} .slider1__prev:hover,.slider1__next:hover{color:white;text-decoration:none;opacity:0.9} .slider1__next{left:auto;right:15px} .slider1__pager{text-align:center;} .slider1__pager a{width:5px;height:5px;border:2px solid #333;border-radius:5px;display:inline-block;margin:0 5px 0 0;transition:all 1s ease} .slider1__pager a:hover{background:#666} .slider1__pager a.active{background:#333} .slider1__pager span{display:none} .slider1__pager a,a.slider1__prev,a.slider1__next{-webkit-box-sizing: content-box;-moz-box-sizing: content-box;box-sizing: content-box;} </style>").appendTo('head');
        document.film_roll_styles_added = true;
      }
      if (this.options.pager !== false) {
        this.pager = $('<div class="slider1__pager">');
      ...
      this.pager_links = this.div.find('.slider1__pager a');
      ...
      if (this.options.hover !== false) {
        this.mouse_catcher = $('<div style="position:absolute; top:0; left: 0; height: 100%; width: 100%;" class="slider1__mouse_catcher"></div>');
      ...
      if (this.options.prev !== false) {
        if (this.options.prev && this.options.next) {
          ...
          this.wrapper.append('<a class="slider1__prev" href="#">&lsaquo;</a>');
          this.prev = this.div.find('.slider1__prev');
        }
      ...
      if (this.options.next !== false) {
        if (this.options.next) {
          ...
          this.wrapper.append('<a class="slider1__next" href="#">&rsaquo;</a>');
          this.next = this.div.find('.slider1__next');
        }
      ...
      this.easing = this.options.easing || FilmRoll1.default_easing;
    ...
    FilmRoll1.prototype.bestDirection = function(child, rotation_index) {
    ...
    FilmRoll1.prototype.cancelClick = function(event) {
    ...
    FilmRoll1.prototype.childIndex = function(child) {
      return $.inArray(child, this.children);
    };

    FilmRoll1.prototype.childWidth = function(child) {
      var index;
      index = this.childIndex(child);
      return this.child_widths[index] || $(child).outerWidth(true);
    };

    FilmRoll1.prototype.clearScroll = function() {
    ...
    FilmRoll1.prototype.configureHover = function() {
    ...
    FilmRoll1.prototype.configureLoad = function() {
    ...
    FilmRoll1.prototype.configureScroll = function() {
    ...
    FilmRoll1.prototype.configureSwipe = function() {
    ...
    FilmRoll1.prototype.configureWidths = function() {
      var min_height;
      ...
      this.shuttle.width('').removeClass('slider1__shuttle').addClass('slider1__resizing');
      this.children.width('');
      this.div.trigger($.Event("fr:resizing"));
      this.child_widths = [];
      ...
      this.shuttle.width(this.real_width * 2).removeClass('slider1__resizing').addClass('slider1__shuttle');
    ...
    FilmRoll1.prototype.rotationIndex = function(child) {
      return $.inArray(child, this.rotation);
    };

    FilmRoll1.prototype.marginLeft = function(rotation_index) {
    ...
    FilmRoll1.prototype.marginRight = function(rotation_index) {
    ...
    FilmRoll1.prototype.moveLeft = function() {
      this.index = (this.index + 1) % this.children.length;
      this.moveToIndex(this.index, 'left', true);
      return false;
    };

    FilmRoll1.prototype.moveRight = function() {
      this.index -= 1;
      if (this.index < 0) {
    ...
    FilmRoll1.prototype.moveToChild = function(element) {
      var child_index;
    ...
    FilmRoll1.prototype.moveToIndex = function(index, direction, animate) {
    ...
    FilmRoll1.prototype.resize = function() {
    ...
    FilmRoll1.prototype.rotateLeft = function() {
    ...
    FilmRoll1.prototype.rotateRight = function() {
  ...
  return this.FilmRoll1.default_easing = 'swing';
})(jQuery);
